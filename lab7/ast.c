/* 
    ...
    LAB 7 ADDITOINS: 
    This lab assignment builds on the previous lab by adding more functionality to the AST. 
    Ive added symbol table integration -- keeping track of variable scopes, levels, 
    and offsets in the AST nodes. Ive added more error handling and added details in AST printouts. 
    I added the check_params function to compare actual and formal parameters in function calls.
