/*  
    ...
    This file conatins the symbol table and the functions that are used to manipulate the symbol table.
    The symbol table is used to store the variables and their attributes that are used in the CMINUS+ program.
